...
@Composable
fun PrivacyPolicyScreen(navController: NavController, modifier: Modifier = Modifier) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
fun PrivacyPolicyScreenPrev(modifier: Modifier = Modifier) {
